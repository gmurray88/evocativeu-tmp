...
const PandemicGetawaySausalito2021SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/pandemic-getaway-sausalito-2021"}}
...
export default PandemicGetawaySausalito2021SlideShow;
