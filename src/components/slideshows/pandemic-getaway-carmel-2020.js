...
const PandemicGetawayCarmel2020SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/pandemic-getaway-carmel-2020"}}
...
export default PandemicGetawayCarmel2020SlideShow;
