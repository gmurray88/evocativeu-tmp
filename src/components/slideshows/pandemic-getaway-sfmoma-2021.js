...
const PandemicGetawaySFMOMA2021SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/pandemic-getaway-sfmoma-2021"}}
...
export default PandemicGetawaySFMOMA2021SlideShow;
