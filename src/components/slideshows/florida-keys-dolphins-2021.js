...
const FloridaKeysDolphins2021SlideShow = () => {
  const { allFile } = useStaticQuery(
    graphql`
    query {
        allFile(
            filter: {relativeDirectory: {eq: "slideshows/florida-keys-dolphins-2021"}}
...
export default FloridaKeysDolphins2021SlideShow;
